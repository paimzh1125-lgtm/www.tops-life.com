...
const Home: React.FC = () => {
  ...
  useEffect(() => {
    // Intro Animation
    if (introRef.current) {
        gsap.fromTo(introRef.current.querySelector('.intro-logo'),
            { opacity: 0, x: 50 },
            { 
  ...
  return (
    <div className="bg-tops-white">
      ...
      {/* Intro Section */}
      <section ref={introRef} className="py-24 px-6 md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row gap-12 items-center relative z-20">
        <div className="flex-1">
          <span className="text-tops-blue font-bold tracking-widest text-sm uppercase mb-2 block">Who We Are</span>
          <h2 className="text-3xl md:text-4xl font-bold text-tops-dark mb-8">苏州托普斯生物科技有限公司</h2>
          <p className="text-slate-600 leading-loose text-lg mb-6">
            苏州托普斯生物科技有限公司（Suzhou Tops Life Technology Co., Ltd.）是一家以技术为驱动的制造商，专业深耕医用软包装、精密注塑部件及新型生物材料领域。我们将科学专业知识与先进生产体系相结合，为全球生命科学产业提供支持。
          </p>
           ...
           <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                { label: "功能涂布", sub: "Functional Coatings", icon: Settings },
                  ...
                  <div key={i} className="aspect-square bg-white flex flex-col items-center justify-center p-6 border border-slate-100 hover:border-tops-blue transition-colors group cursor-pointer">
         ...
         <div className="container mx-auto px-6 flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 h-[400px] w-full rounded-2xl overflow-hidden relative">
               <img 
                 ...
                 data-speed="0.9" // For potential future parallax lib
               />
