                ...
                <div className="absolute inset-0 flex items-center px-6 md:px-12 lg:px-24">
                  <div className="max-w-4xl text-white pt-12">
                    ...
                    <div className="overflow-hidden mb-6">
                      <div className="animate-slide-up-fade [animation-delay:100ms] inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-sky-400/20 bg-sky-900/20 backdrop-blur-md text-sky-300 text-xs font-bold uppercase tracking-widest">
      ...
      <section className="relative py-24 lg:py-32 bg-white z-10 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="order-2 lg:order-1 relative gsap-fade-up">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-white shadow-slate-200">
              ...
              {/* 装饰性渐变 */}
              <div className="absolute inset-0 bg-gradient-to-tr from-sky-900/30 to-transparent pointer-events-none"></div>
            </div>
            
            {/* 悬浮卡片 - 增加层次感 */}
            <div className="absolute -bottom-8 -right-4 md:right-8 bg-white p-6 rounded-xl shadow-[0_15px_40px_rgba(0,0,0,0.08)] border border-slate-50 animate-float max-w-xs z-20 hidden md:block">
          ...
          <div className="order-1 lg:order-2 gsap-fade-up">
            ...
            <h3 className="text-3xl md:text-4xl lg:text-[2.6rem] font-extrabold text-slate-900 mb-8 leading-tight">
              {t.companyPrefix}<span className="text-sky-500">{t.companySuffix}</span>
            </h3>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {t.solutions.map((item, idx) => (
              <div key={idx} className="gsap-fade-up group relative bg-white rounded-3xl p-8 shadow-sm hover:shadow-xl hover:shadow-sky-100/50 transition-all duration-300 border border-slate-100 hover:-translate-y-1">
                {/* 顶部图标区域 */}
                <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-8 text-white shadow-lg transition-transform duration-500 group-hover:scale-110 ${
